...
public class Datas {
	...
	public static int obterDiferencaEntreDatasEmDias(Date data1, Date data2){
		long tempoMs = Math.abs(data1.getTime() - data2.getTime());
		return Math.round(tempoMs / (1000 * 60 * 60 * 24));
	}
	...
	public static Calendar calcularVencimento() {
		Calendar cal = Calendar.getInstance();
